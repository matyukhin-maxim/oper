    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="col-xs-2 text-center">
                ...
                <input type="text" class="form-control mtime" readonly value="<?= get_param($time_agree,null);?>"/>
            </div>
            <div class="col-xs-7">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="btn-group btn-group-justified">
                            <a href="/journal/compositions/<?= get_param($eid); ?>" class="btn btn-default" title="Состав смены">Состав смены</a>
                            <a href="/journal/equipment/<?= get_param($eid); ?>" class="btn btn-default" title="Оборудование">Оборудование</a>
                        <?php 
